...
public class EvaluationDTO {
	...
	public String getCraditScore() {
		return craditScore;
	}
	public void setCraditScore(String craditScore) {
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			...
			String totalScore, String craditScore, String lectureScore, String comfortableScore, int likeCount) {
		super();
		this.evaluationID = evaluationID;
		this.userID = userID;
		this.lectureName = lectureName;
